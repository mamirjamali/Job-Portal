    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jobType', models.CharField(choices=[('Permenet', 'Permeanet'), ('Temporary', 'Temporary'), ('Intership', 'Intership')], default='Permenet', max_length=10)),
                ...
                ('experience', models.CharField(choices=[('No Experience', 'No Experience'), ('1 Year', 'One Yaer'), ('2 Years', 'Two Yaer'), ('3 Years above', 'Three Year Plus')], default='No Experience', max_length=20)),
