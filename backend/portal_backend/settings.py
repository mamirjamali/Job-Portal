...
INSTALLED_APPS = [
    ...
    'rest_framework_simplejwt', 'rest_framework', 'corsheaders', 'storages',
    'django.contrib.gis', 'django_filters', 'job.apps.JobConfig', 'account'
]
...
CROS_ALLOWED_ORIGINS = ['http://localhost:3000', 'http://127.0.0.1:3000']
